...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/layout/board/list/**").permitAll()
                .antMatchers("/layout/board/detail/**").permitAll()
                .antMatchers("/layout/board/**").authenticated()
                .antMatchers("/layout/diary/**").authenticated()
            ...
            .formLogin()
                ...
                .and()
            .logout()
                .logoutSuccessUrl("/layout/board/list")
                .permitAll();
    }
